      ...
      <div className={`ratings ${showRatings ? 'show' : 'hide'}`}>
        ...
        <a href='/feedbacks'>
          <div className="flex items-center">
            ...
            <p className="ms-1 lg:text-[15px] md:text-[14px] sm:text-[13px] ml:text-[12px] mm:text-[11px] text-[10px] font-['RfDewi-Expanded'] font-[700] text-white">4.5</p>
            ...
            <p className="ms-1 lg:text-[15px] md:text-[14px] sm:text-[13px] ml:text-[12px] mm:text-[11px] text-[10px] font-['RfDewi-Expanded'] font-[700] hidden ms:block text-white">Based on <a href='/feedbacks' className='underline'>286 Reviews</a></p>
          </div>
        </a>
